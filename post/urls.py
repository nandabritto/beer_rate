...
from .views import HomeView, BeerRatingView, AddReviewView, ReviewDetailView, UpdateReviewView, DeleteReviewView
...
urlpatterns = [
    ...
    path('review_list/<int:pk>/delete', DeleteReviewView.as_view(), name='review_delete'),
